...
error_log("[contact.php] Session state on page load (after restore, header commented): " . print_r($_SESSION, true));
        ...
        <div class="container mx-auto px-4">
            <div class="max-w-4xl mx-auto">
                ...
                <div class="bg-[#0B2447] rounded-lg shadow-lg p-8 mb-12">
                    ...
                    <?php 
                        error_log("[contact.php] Session state JUST BEFORE message display block (after restore, header commented): " . print_r($_SESSION, true));
                        if (isset($_SESSION['contact_form_message'])):
